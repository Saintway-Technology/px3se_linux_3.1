...
static void adc_depop_work_events(struct work_struct *work)
{
	...
	snd_soc_write(tron_codec, 0x1A, 0x00);
	snd_soc_write(tron_codec, 0x54, 0x00);
	snd_soc_write(tron_codec, 0x09, 0x04);
	snd_soc_write(tron_codec, 0x2e, 0x11);
	snd_soc_write(tron_codec, 0x2f, 0x00);
	snd_soc_write(tron_codec, 0x30, 0xbb);
	snd_soc_write(tron_codec, 0x31, 0x02);
	snd_soc_write(tron_codec, 0x62, 0x40);
	snd_soc_write(tron_codec, 0x63, 0x40);
	snd_soc_write(tron_codec, 0x60, 0x00);
	snd_soc_write(tron_codec, 0x61, 0x33);
	snd_soc_write(tron_codec, 0x53, 0x00);
	snd_soc_write(tron_codec, 0x5e, 0x00);
	snd_soc_write(tron_codec, 0x20, 0x40);
	snd_soc_write(tron_codec, 0x77, 0x40);
	snd_soc_write(tron_codec, 0x77, 0x00);
	snd_soc_write(tron_codec, 0x56, 0x00);
	snd_soc_write(tron_codec, 0x57, 0x00);
	snd_soc_write(tron_codec, 0x58, 0xca);
	snd_soc_write(tron_codec, 0x59, 0x12);
	snd_soc_write(tron_codec, 0x5b, 0x0a);
	snd_soc_write(tron_codec, 0x5c, 0xc8);
	snd_soc_write(tron_codec, 0x5d, 0x11);
	snd_soc_write(tron_codec, 0x75, 0x82);
	snd_soc_write(tron_codec, 0x74, 0x68);
	snd_soc_write(tron_codec, 0x20, 0x00);
			      ...
			      struct snd_soc_dai *dai)
{
	 ...
	 */
       ...
       snd_soc_write(tron_codec, 0x2f, 0x99);
       snd_soc_write(tron_codec, 0x30, 0xaa);
       snd_soc_write(tron_codec, 0x31, 0x02);
       snd_soc_write(tron_codec, 0x62, 0x00);
       snd_soc_write(tron_codec, 0x63, 0x00);
       snd_soc_write(tron_codec, 0x60, 0x22);
       snd_soc_write(tron_codec, 0x61, 0x33);
       snd_soc_write(tron_codec, 0x53, 0x00);
       snd_soc_write(tron_codec, 0x5e, 0x00);
       snd_soc_write(tron_codec, 0x20, 0x40);
       ...
       snd_soc_write(tron_codec, 0x56, 0x00);
       snd_soc_write(tron_codec, 0x57, 0x00);
       snd_soc_write(tron_codec, 0x58, 0xc6);
       snd_soc_write(tron_codec, 0x59, 0x12);
       snd_soc_write(tron_codec, 0x5b, 0x0a);
       snd_soc_write(tron_codec, 0x5c, 0xc8);
       snd_soc_write(tron_codec, 0x5d, 0x11);
       snd_soc_write(tron_codec, 0x75, 0x02);
       snd_soc_write(tron_codec, 0x74, 0x78);
       snd_soc_write(tron_codec, 0x20, 0x00);
...
static int es8396_probe(struct snd_soc_codec *codec)
{
	...
	if (regv == 0x00) {
		...
		snd_soc_write(codec, ES8396_SDP_1_MS_REG12, 0x00);
