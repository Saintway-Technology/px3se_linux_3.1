...
static struct vehicle_sensor_ops sensor_cb_series[] = {
	...
	{
		.name = "adv7180",
		.sensor_init = adv7180_ad_init,
		.sensor_deinit = adv7180_ad_deinit,
		.sensor_get_cfg = adv7180_ad_get_cfg,
		.sensor_check_cif_error = adv7180_ad_check_cif_error,
		.sensor_check_id_cb = adv7180_check_id
	},
	{
		.name = "tp2825",
